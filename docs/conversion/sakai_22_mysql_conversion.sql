...
-- SAK-43155
ALTER TABLE ASN_ASSIGNMENT ADD REQUIRED_ESTIMATE CHAR(1) NULL;
...
ALTER TABLE ASN_ASSIGNMENT ADD CONSTRAINT CHECK_REQUIRED_ESTIMATE CHECK (REQUIRED_ESTIMATE IN ('0', '1'));
