...
-- SAK-46257
ALTER TABLE CONV_POSTS ADD DEPTH NUMBER(2, 0) DEFAULT NULL;
ALTER TABLE CONV_TOPIC_STATUS ADD POSTED CHAR(1) DEFAULT NULL;
...
ALTER TABLE CONV_POSTS ADD HOW_ACTIVE NUMBER(2, 0) DEFAULT NULL;
ALTER TABLE CONV_COMMENTS ADD TOPIC_ID VARCHAR2(36) NOT NULL;
ALTER TABLE CONV_POSTS ADD NUMBER_OF_THREAD_REACTIONS NUMBER(8, 0) DEFAULT NULL;
ALTER TABLE CONV_POSTS ADD NUMBER_OF_THREAD_REPLIES NUMBER(8, 0) DEFAULT NULL;
ALTER TABLE CONV_POSTS ADD PARENT_THREAD_ID VARCHAR2(255) DEFAULT NULL;
ALTER TABLE CONV_TOPICS ADD MUST_POST_BEFORE_VIEWING CHAR(1) DEFAULT NULL;
