...
ALTER TABLE USER_NOTIFICATIONS ADD COLUMN TOOL VARCHAR(99);

ALTER TABLE LTI_TOOLS ADD COLUMN LTI13_LMS_DEPLOYMENT_ID VARCHAR(1024);

-- SAK-50846 --
ALTER TABLE SST_PRESENCES ADD COLUMN CURRENT_OPEN_SESSIONS INT DEFAULT 0 NOT NULL;
-- END SAK-50846 --