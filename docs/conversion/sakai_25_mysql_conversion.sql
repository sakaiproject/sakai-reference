...
ALTER TABLE rbc_evaluation DROP KEY UKdn0jue890jn9p7vs6tvnsf2gf;
...
CREATE INDEX SCORM_DELIM_DESC_VAL_IDX ON SCORM_DELIMIT_DESC_T (VALIDATOR);
CREATE INDEX SCORM_DM_NAV_REQS_IDX ON SCORM_DATAMODEL_T (NAV_REQUESTS);

ALTER TABLE SCORM_LIST_ELEM_DESC_T
    ADD CONSTRAINT FK1iyus9lmmt8qxh9hqn9a79ag2 FOREIGN KEY (CHILD_ID) REFERENCES SCORM_ELEMENT_DESC_T (ELEM_DESC_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_MAP_CHILDREN_T
    ADD CONSTRAINT FK4533ssr4ehx10yoxdbvht7o61 FOREIGN KEY (CHILD_ID) REFERENCES SCORM_ELEMENT_T (ELEMENT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_DELIMITER_T
    ADD CONSTRAINT FK4yccihmov0qlo7uotini25hdp FOREIGN KEY (VALIDATOR) REFERENCES SCORM_TYPE_VALIDATOR_T (ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_ELEMENT_T
    ADD CONSTRAINT FK60klo5ulb0o2fcxuwqvr4hrv6 FOREIGN KEY (ELEMENT_DM) REFERENCES SCORM_DATAMODEL_T (DATAMODEL_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_DATAMODEL_T
    ADD CONSTRAINT FK8hjtj5urddedfregxr65q8s2p FOREIGN KEY (NAV_REQUESTS) REFERENCES SCORM_ADL_VALID_REQUESTS_T (VALID_REQUESTS_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_LAUNCH_DATA_T
    ADD CONSTRAINT FK9gqdu7cph1qg4ch6g4lwtl00b FOREIGN KEY (MANIFEST_ID) REFERENCES SCORM_CP_MANIFEST_T (MANIFEST_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_MAP_ELEMENTS_T
    ADD CONSTRAINT FKcnnvucotqnamlm25nth5km2oo FOREIGN KEY (ELEMENT_ID) REFERENCES SCORM_ELEMENT_T (ELEMENT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_MAP_ELEMENTS_T
    ADD CONSTRAINT FKdgxhepepwuaiw5uh4w6mtqae8 FOREIGN KEY (DATAMODEL_ID) REFERENCES SCORM_DATAMODEL_T (DATAMODEL_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_LAUNCH_DATA_T
    ADD CONSTRAINT FKg4d2lpi7xv1wigv3vigu62p1a FOREIGN KEY (LAUNCH_DATA_ID) REFERENCES SCORM_LAUNCH_DATA_T (LAUNCH_DATA_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_DELIMIT_DESC_T
    ADD CONSTRAINT FKg4mvbtnbxt32tkr9jv9j9ycbt FOREIGN KEY (VALIDATOR) REFERENCES SCORM_TYPE_VALIDATOR_T (ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_ELEMENTS_T
    ADD CONSTRAINT FKg4nnlyv9cv9c1i5n9g041eif5 FOREIGN KEY (ELEMENT_ID) REFERENCES SCORM_ELEMENT_T (ELEMENT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_MAP_DATAMODELS_T
    ADD CONSTRAINT FKh3hc0budun0he9373nrf3kpye FOREIGN KEY (DATAMODEL_ID) REFERENCES SCORM_DATAMODEL_T (DATAMODEL_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_ELEMENTS_T
    ADD CONSTRAINT FKh7wa55pxca3rfku4shfss0172 FOREIGN KEY (DATAMODEL_ID) REFERENCES SCORM_DATAMODEL_T (DATAMODEL_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_RECORDS_T
    ADD CONSTRAINT FKiyfb34ngl98f4epoxeven69m4 FOREIGN KEY (ELEMENT_ID) REFERENCES SCORM_ELEMENT_T (ELEMENT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_DELIMITERS_T
    ADD CONSTRAINT FKn7i3bcgfqnx8ugdtgu8oqcka6 FOREIGN KEY (DELIM_ID) REFERENCES SCORM_DELIMITER_T (DELIM_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_ELEMENT_T
    ADD CONSTRAINT FKneos81gsguh5rxddhly2fdor1 FOREIGN KEY (NAVIGATION_DM) REFERENCES SCORM_DATAMODEL_T (DATAMODEL_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_ELEM_DESC_T
    ADD CONSTRAINT FKo73u7xgfjlantpunhrx4nlwvi FOREIGN KEY (ELEM_DESC_ID) REFERENCES SCORM_ELEMENT_DESC_T (ELEM_DESC_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_DELIMITERS_T
    ADD CONSTRAINT FKogldox6hqgvghusbp23oa27qc FOREIGN KEY (ELEMENT_ID) REFERENCES SCORM_ELEMENT_T (ELEMENT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_DELIM_DESC_T
    ADD CONSTRAINT FKp1o8regkt7yiwhf8wp5ol35ea FOREIGN KEY (ELEM_DESC_ID) REFERENCES SCORM_ELEMENT_DESC_T (ELEM_DESC_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_MAP_DATAMODELS_T
    ADD CONSTRAINT FKptcj0mys6w5gv3mcn5o3dvi47 FOREIGN KEY (DATAMANAGER_ID) REFERENCES SCORM_DATAMANAGER_T (DATAMANAGER_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_MAP_CHILDREN_T
    ADD CONSTRAINT FKr4ulcoxk50jgi5p58o0vkj6yd FOREIGN KEY (ELEMENT_ID) REFERENCES SCORM_ELEMENT_T (ELEMENT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_ELEMENT_T
    ADD CONSTRAINT FKr5qj7hfctt9sqttk25g59j3pf FOREIGN KEY (`DESCRIPTION`) REFERENCES SCORM_ELEMENT_DESC_T (ELEM_DESC_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_RECORDS_T
    ADD CONSTRAINT FKrpg3ygmnj41wv762oycfeijfx FOREIGN KEY (RECORD_ID) REFERENCES SCORM_ELEMENT_T (ELEMENT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_DELIM_DESC_T
    ADD CONSTRAINT FKt380u3n3bo4jfq7ugr1xovqqi FOREIGN KEY (DELIM_DESC_ID) REFERENCES SCORM_DELIMIT_DESC_T (DELIM_DESC_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_LIST_BINDINGS_T
    ADD CONSTRAINT FKtgeta6m8u88ogvop4hkbt4qmm FOREIGN KEY (ELEMENT_ID) REFERENCES SCORM_ELEMENT_T (ELEMENT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_ELEMENT_T
    ADD CONSTRAINT FKtmfmx4swa611msqjx864cldsn FOREIGN KEY (PARENT) REFERENCES SCORM_ELEMENT_T (ELEMENT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SCORM_MAP_SCO_DATAMANAGER_T
    ADD CONSTRAINT FKtr8ol52ol0bfrc39jc95nisg4 FOREIGN KEY (ATTEMPT_ID) REFERENCES SCORM_ATTEMPT_T (ATTEMPT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE PLUS_SUBJECT MODIFY SUBJECT VARCHAR(99);
